...
print()
print('Second card dealt to player #1: {}'.format(player1_card))
print('Player #1 hand:', player1_list)
print()
print('Second card dealt to player #2: {}'.format(player2_card))
print('Player #2 hand:', player2_list)
print()
...
player1_last = player1_list[-1].rank()
player2_last = player2_list[-1].rank()
print()
if player1_last > player2_last:
    print('{} of higher rank than {}'.format(player1_list[-1], player2_list[
        -1]))
elif player1_last < player2_last:
    print('{} of higher rank than {}'.format(player2_list[-1], player1_list[
        -1]))
else:
    print('tie')
